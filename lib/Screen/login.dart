...
Future<void> _login() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      _showDialog("Login Gagal", responseData['message'] ?? "Email atau password salah.");
    }
  } catch (e) {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: isChecked ? Icon(Icons.check, color: Colors.black, size: 16) : null,
                        ),
                      ),
                    ),
                    SizedBox(width: 8),
            ...
            ElevatedButton(
              onPressed: _login,
              child: customText("Login", fontWeight: FontWeight.bold, color: Color(0xFF1E5172)),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Padding(padding: const EdgeInsets.symmetric(horizontal: 20), child: customText("atau")),
                  Expanded(child: Divider(color: Colors.white)),
                ],
              ),
            ),
            ...
            ElevatedButton.icon(
              onPressed: () {},
              icon: Image.asset('assets/google_icon.png', width: 22, height: 22),
